...
const WeeklyActivity: React.FC<WeeklyActivityProps> = ({ weeklyActivity }) => {
  ...
  return (
    <div className="flex flex-col gap-5 items-start justify-start w-full lg:w-[63%] max-w-full min-w-[300px]">
      ...
      <div className="bg-white rounded-[25px] w-full h-[322px] p-4 overflow-hidden">
        <div className="w-full h-full">
          {/* Custom Legend */}
          <div className="flex justify-end mb-4 gap-8">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-accent"></div>
              <span className="text-secondary text-[12px] md:text-lg">
                Deposit
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-background-dark"></div>
              <span className="text-secondary text-[12px] md:text-lg">
                Withdraw
              </span>
            </div>
